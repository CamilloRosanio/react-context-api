...
export const PostsContextProvider = ({ children }) => {
    ...
    // E' fondamentale che i dati siano importati all'INTERNO del COMPONENT per evitare errori di ASYNC. Importandoli sopra, i dati potrebbero NON essere caricati al MOUNTING del COMPONENT
    const postsData = {
        postsList: [
            {
                id: 2,
